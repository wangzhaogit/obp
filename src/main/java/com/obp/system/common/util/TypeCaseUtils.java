...
public class TypeCaseUtils {
	...
	public static Object convert(Object obj, String type, String format){
		...
		if (obj instanceof String) {
			...
			if ("Double".equals(type) || "java.lang.Double".equals(type))
				try {
					...
					throw new CommonException("Could not convert " + str + " to " + type + ": ");
				}
			...
			if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type)) {
				...
				throw new CommonException("Conversion from " + fromType + " to " + type
		...
		if ("String".equals(type) || "java.lang.String".equals(type))
			...
			throw new CommonException("Conversion from " + obj.getClass().getName() + " to "
	...
	public static Boolean convert2SBoolean(Object obj) throws CommonException {
		return (Boolean) convert(obj, "Boolean", null);
	}

	public static Integer convert2Integer(Object obj) throws CommonException {
		return (Integer) convert(obj, "Integer", null);
	}

	public static String convert2String(Object obj) throws CommonException {
		return (String) convert(obj, "String", null);
	}

	public static String convert2String(Object obj, String defaultValue) throws CommonException {
	...
	public static Long convert2Long(Object obj) throws CommonException {
		return (Long) convert(obj, "Long", null);
	}

	public static Double convert2Double(Object obj) throws CommonException {
		return (Double) convert(obj, "Double", null);
	}

	public static BigDecimal convert2BigDecimal(Object obj, int scale) throws CommonException {
		return ((BigDecimal) convert(obj, "BigDecimal", null)).setScale(scale, 5);
	}

	public static Date convert2SqlDate(Object obj, String format) throws CommonException {
		return (Date) convert(obj, "Date", format);
	}

	public static Timestamp convert2Timestamp(Object obj, String format) throws CommonException {

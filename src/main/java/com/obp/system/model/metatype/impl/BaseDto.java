package com.obp.system.model.metatype.impl;
...
import com.obp.system.common.util.TypeCaseUtils;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public BigDecimal getAsBigDecimal(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "BigDecimal", null);
		if (obj != null)
	...
	public Date getAsDate(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "Date", "yyyy-MM-dd");
		if (obj != null)
			return (Date) obj;
		else
			return null;
	...
	public Integer getAsInteger(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "Integer", null);
		if (obj != null)
			return (Integer) obj;
		else
			return null;
	...
	public Long getAsLong(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "Long", null);
		if (obj != null)
			return (Long) obj;
		else
			return null;
	...
	public String getAsString(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "String", null);
		if (obj != null)
			return (String) obj;
		else
			return "";
	...
	public Timestamp getAsTimestamp(String key) {
		Object obj = TypeCaseUtils.convert(get(key), "Timestamp", "yyyy-MM-dd HH:mm:ss");
		if (obj != null)
	...
	public Boolean getAsBoolean(String key){
		Object obj = TypeCaseUtils.convert(get(key), "Boolean", null);
		if (obj != null)
			return (Boolean) obj;
		else
			return null;
